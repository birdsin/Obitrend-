...
addTextButton?.addEventListener("click",()=>{if(!extraPromptWrap)return;const open=extraPromptWrap.dataset.open==="true";extraPromptWrap.dataset.open=open?"false":"true";extraPromptWrap.classList.toggle("hidden",open);updateExtraPromptUI();if(!open)extraPrompt?.focus();});
